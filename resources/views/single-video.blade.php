        ...
        <div class="row mb-50">
            <div class="col-lg-8 col-md-12">
                ...
                <div class="single-excerpt">
                    <p class="font-large">Now that we have mentioned it, you probably perfectly understand why it is important for the payment process to go as smoothly as possible. After all, if a customer has to go through a million of steps to send you money, they will probably just give up. Strategies for email campaigns vary, but the email newsletter lies at the heart of each. It is a sort of a decider: whether your readers will be back or ditch you and your company. But make sure that every email newsletter looks pleasing and is unobtrusive.</p>
                </div>
                <div class="entry-main-content">
                    ...
                    <div class="wp-block-image">
                        <figure class="alignright is-resized">
                            <video autoplay="" class="photo-item__video" loop="" muted="" preload="none">
                                <source src="https://player.vimeo.com/external/404542987.sd.mp4?s=0cbd2cd3ff13de53a573fcf875ebbe75bc1d9e9d&amp;profile_id=139&amp;oauth2_token_id=57447761" type="video/mp4">
                            </video>
                    ...
                    <h2>Something fresh is coming</h2>
                    <hr class="wp-block-separator is-style-wide">
                    <div class="wp-block-image">
