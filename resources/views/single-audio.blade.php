    ...
    <div class="container">
        <div class="entry-header entry-header-1 mb-30 mt-50">
            <div class="entry-meta meta-0 font-small mb-30">
                <a href="category.html"><span class="post-cat bg-danger color-white">Culture</span></a>
                <a href="category.html"><span class="post-cat bg-success color-white">Music</span></a>
            </div>
            <h1 class="post-title mb-30">
                The songs topped the April charts, <br> Rap music to the throne after months
            </h1>
            <div class="entry-meta meta-1 font-x-small color-grey text-uppercase">
                <span class="post-by">By <a href="author.html">Monico </a> & <a href="author.html">Alentica</a></span>
        ...
        <div class="row mb-50">
            <div class="col-lg-8 col-md-12">
                ...
                <figure class="single-thumnail mb-30">
                    <iframe width="100%" height="166" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/533970252&color=%23ff5500&auto_play=true&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe>
                </figure>
                <div class="single-excerpt">
                    <p class="font-large">Below you'll find an alphabetized list of NPR Music's top 14 songs of April 2020. Be sure to check out our top 14 albums from the month and, above, listen to the Best of April podcast from All Songs Considered. </p>
                </div>
                <div class="entry-main-content">
                    <h2>Stream this playlist via Spotify. </h2>
                    <hr class="wp-block-separator is-style-wide">
                    <p>As the NPR Music staff continues to cover the pandemic and its effects on the music industry, we are still listening to new music. In fact, we started Press Pause and Hit Play, a new playlist updated daily, in an effort to catalog our favorites released during this time.</p>
                    <p>We did something different for April. Instead of long discussions over email and video chat to determine which songs would make our monthly list, each staff member was guaranteed their No. 1 pick. We don't always share our list-making process, but the results seen below reveal the music held closest to the chest, what gets repeat listens during quarantine.</p>
                    <figure>
                        <iframe width="100%" height="450" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/204098661&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe>
                        <div style="font-size: 10px; color: #cccccc;line-break: anywhere;word-break: normal;overflow: hidden;white-space: nowrap;text-overflow: ellipsis; font-family: Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif;font-weight: 100;"><a href="https://soundcloud.com/djamila-rouane" title="Jomana" target="_blank" style="color: #cccccc; text-decoration: none;">Jomana</a> · <a href="https://soundcloud.com/djamila-rouane/sets/free" title="free" target="_blank" style="color: #cccccc; text-decoration: none;">free</a></div>
                    </figure>
                    ...
                    <div class="wp-block-image">
                        <figure class="alignleft is-resized">
                            <img class="border-radius-5" src="assets/imgs/ads-1.jpg">
                    ...
                    <div class="row">
                        ...
                        <article class="col-lg-4">
                            <div class="background-white border-radius-10 p-10 mb-30">
                                ...
                                <div class="pl-10 pr-10">
                                    <div class="entry-meta mb-15 mt-10">
                                        <a class="entry-meta meta-2" href="category.html"><span class="post-in text-success font-x-small">Tech</span></a>
                                    </div>
                                    <h5 class="post-title mb-15">
                                                <span class="post-format-icon">
                        ...
                        <ul class="list-post">
                            <li class="mb-30 wow fadeIn animated">
                                <div class="d-flex">
                                    ...
                                    <div class="post-content media-body">
                                        <h6 class="post-title mb-10 text-limit-2-row"><a href="single.html">Marathon Runners Build Their Sport Stride by Stride</a></h6>
                            ...
                            <li class="mb-30 wow fadeIn animated">
                                <div class="d-flex">
                                    ...
                                    <div class="post-content media-body">
                                        <h6 class="post-title mb-10 text-limit-2-row"><a href="single.html">Casa Dani, From a Michelin Chef, to Open in Manhattan West</a></h6>
                                        <div class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase">
                            ...
                            <li class="wow fadeIn animated">
                                <div class="d-flex">
                                    ...
                                    <div class="post-content media-body">
                                        <h6 class="post-title mb-10 text-limit-2-row"><a href="single.html">What Will It Take to Reopen the World to Travel?</a></h6>
                                        <div class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase">
