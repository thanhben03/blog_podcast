                    ...
                    <div class="col-xl-4">
                        <div class="card profile-card">
                            <div class="card-body">
                                ...
                                <div class="text">
                                    <h3 class="card-title">My Recent Article and Publications</h3>
                                    <p>I'm here to help if you're searching for a product designer to bring your idea to life or a design partner to help take your business to the next level.
                                    ...
                                    <div class="common-button-groups">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                <li><a class="dropdown-item" href="#">Sử dụng MT5</a></li>
                                                <li><a class="dropdown-item" href="#">Sử dụng Ctrade</a></li>
                                                <li><a class="dropdown-item" href="#">Sử dụng Xtrader</a></li>
                                                <li><a class="dropdown-item" href="#">Thiết lập Copy Trade</a></li>
                                            </ul>
                                        </div>
                                        <a
                                            style="
