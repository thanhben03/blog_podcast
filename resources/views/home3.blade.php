    ...
    <div class="post-carausel-1-items mb-50">
        <div class="col">
            <div class="slider-single bg-white p-10 border-radius-15">
                ...
                <h6 class="post-title pr-5 pl-5 mb-10 mt-15 text-limit-2-row">
                    <a href="single.html">Reflections from a Token Black Friend</a>
                </h6>
                <div class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase pl-5 pb-15">
                    <span class="post-by">By <a href="author.html">J. Steven</a></span>
                    <span class="post-on">2m ago</span>
                </div>
            </div>
        </div>
        <div class="col">
        ...
        <div class="col">
            <div class="slider-single bg-white p-10 border-radius-15">
                ...
                <h6 class="post-title pr-5 pl-5 mb-10 mt-15 text-limit-2-row">
                    <a href="single.html">4 Things Emotionally Intelligent People Don’t Do</a>
                </h6>
                <div class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase pl-5 pb-15">
                    <span class="post-by">By <a href="author.html">H.Rosie</a></span>
                    <span class="post-on">13m ago</span>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="slider-single bg-white p-10 border-radius-15">
                ...
                <h6 class="post-title pr-5 pl-5 mb-10 mt-15 text-limit-2-row">
                    <a href="single.html">How line-dried laundry gets that fresh smell</a>
                </h6>
                <div class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase pl-5 pb-15">
                    <span class="post-by">By <a href="author.html">K. Marry</a></span>
        ...
        <div class="col">
            <div class="slider-single bg-white p-10 border-radius-15">
                ...
                <div class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase pl-5 pb-15">
                    <span class="post-by">By <a href="author.html">K. Kenedy</a></span>
                    <span class="post-on">12m ago</span>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="slider-single bg-white p-10 border-radius-15">
                ...
                <h6 class="post-title pr-5 pl-5 mb-10 mt-15 text-limit-2-row">
                    <a href="single.html">Federal arrests show no sign that antifa plotted</a>
                </h6>
                <div class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase pl-5 pb-15">
                    <span class="post-by">By <a href="author.html">K. Henry</a></span>
