            ...
            <div class="thumb-overlay img-hover-slide border-radius-5 position-relative" style="background-image: url(assets/imgs/news-24.jpg)">
                <div class="position-midded">
                    <div class="entry-meta meta-0 font-small mb-30">
                        <a href="category.html"><span class="post-cat bg-success color-white">Discovery</span></a>
                        <a href="category.html"><span class="post-cat bg-info color-white">Nature</span></a>
                    </div>
                    <h1 class="post-title mb-30 text-white">
                        Explore the most beautiful forests in the world
                    </h1>
                    <div class="entry-meta meta-1 font-x-small color-grey text-uppercase text-white">
                        <span class="post-by text-white">By <a class="text-white" href="author.html">Adam Liptak </a> & <a class="text-white" href="author.html">Michael D. Shear</a></span>
                        <span class="post-on text-white">18/09/2020 09:35 EST</span>
                        <span class="time-reading text-white">12 mins read</span>
                    ...
                    <div class="wp-block-image">
                        <figure class="alignleft is-resized">
                            <video autoplay="" class="photo-item__video" loop="" muted="" preload="none">
                                <source src="https://player.vimeo.com/external/390988154.sd.mp4?s=2afbf9887b38c30d0501343dec67006c7656f73f&amp;profile_id=139&amp;oauth2_token_id=57447761" type="video/mp4">
                            </video>
                            <figcaption> And far contrary smoked some contrary among stealthy </figcaption>
                        </figure>
                    </div>
