                                    ...
                                    <li class="mega-menu-item">
                                        ...
                                        <div class="sub-mega-menu sub-menu-list row text-muted font-small">
                                            <ul class="col-md-2">
                                                ...
                                                <li><a href="/category-grid">Category grid</a></li>
                                                <li><a href="/category-big">Category big</a></li>
                                                <li><a href="/category-metro">Category metro</a></li>
                                            </ul>
                                            <ul class="col-md-2">
                                                <li><strong>Post format</strong></li>
                                                <li><a href="/single">Post standard</a></li>
                                                <li><a href="/single-video">Post video</a></li>
                                                <li><a href="/single-gallery">Post gallery</a></li>
                                                <li><a href="/single-audio">Post audio</a></li>
                                                <li><a href="/single-image">Post image</a></li>
                                                <li><a href="/single-full">Post full width</a></li>
                                            </ul>
                                            <ul class="col-md-2">
