...
@section('content')
    ...
    <div class="container">
        <div class="entry-header entry-header-1 mb-30 mt-50">
            <div class="entry-meta meta-0 font-small mb-30"><a href="category.html"><span class="post-cat bg-success color-white">Global News</span></a></div>
        ...
        <div class="row mb-50">
            <div class="col-lg-8 col-md-12">
                ...
                <figure class="single-thumnail mb-30">
                    <img src="assets/imgs/news-23.jpg" alt="">
                ...
                <div class="entry-main-content">
                    ...
                    <figure class="wp-block-gallery columns-3">
                        <ul class="blocks-gallery-grid">
                            <li class="blocks-gallery-item"><a href="#"><img class="border-radius-5" src="assets/imgs/thumbnail-1.jpg" alt=""></a></li>
                            <li class="blocks-gallery-item"><a href="#"><img class="border-radius-5" src="assets/imgs/thumbnail-2.jpg" alt=""></a></li>
                            <li class="blocks-gallery-item"><a href="#"><img class="border-radius-5" src="assets/imgs/thumbnail-10.jpg" alt=""></a></li>
                        </ul>
                    </figure>
                    ...
                    <div class="wp-block-image">
                        <figure class="alignleft is-resized">
                            <img class="border-radius-5" src="assets/imgs/thumbnail-14.jpg">
